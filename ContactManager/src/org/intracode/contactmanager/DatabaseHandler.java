...
/**
 * Created by Juan Molero on 19.01.14.
 */
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void createContact(Contact contact) {
        ...
        values.put(KEY_NAME, contact.getNombre());
        values.put(KEY_PHONE, contact.getTelefono());
        values.put(KEY_EMAIL, contact.getEmail());
        values.put(KEY_ADDRESS, contact.getDireccion());
